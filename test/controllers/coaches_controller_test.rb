...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { first_name: @coach.first_name, gender: @coach.gender, img_ref: @coach.img_ref, last_name: @coach.last_name, started: @coach.started }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { first_name: @coach.first_name, gender: @coach.gender, img_ref: @coach.img_ref, last_name: @coach.last_name, started: @coach.started }
    assert_redirected_to coach_path(assigns(:coach))
  end
